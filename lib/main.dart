...
class _MapState extends State<Map> {
  ...
  @override
  Widget build(BuildContext context) {
    //if else for either showing the current location if location is enabled or showing progress bar if its not
  ...
  void createRoute(String encodedPoly) {
    setState(() {
      _polyLines.add(Polyline(
          ...
          points: convertoLatLng(_decodePoly(encodedPoly)),
          width: 20,
          color: Colors.black));
    });
  }
